      ...
      <div className="hero-asymmetric py-16 lg:py-24">
        <div>
          ...
          <p className="mt-6 text-lg text-iron-600 sm:text-xl max-w-2xl">
            ...
            family. Join our community of home cooks and discover amazing
            dishes.
          </p>
        ...
        <div className="hidden lg:block">
          <div className="w-full h-64 bg-linen-100 rounded-lg flex items-center justify-center">
            <svg
              className="w-16 h-16 text-iron-400"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="mt-2 text-iron-600">
              Discover popular dishes from our community
            </p>
          </div>
          <Link
            href="/auth/signin"
        ...
        {isLoading ? (
          <div className="recipe-grid">
            {[...Array(6)].map((_, i) => (
              <div
                key={i}
                className="bg-white rounded-lg shadow-sm border border-linen-200 animate-pulse"
              >
          ...
          <div className="text-center py-12 bg-linen-50 rounded-lg">
            ...
            <h3 className="mt-4 text-lg font-medium text-iron-900">
              No recipes yet
            </h3>
            <p className="mt-2 text-iron-600">
      ...
      <section className="py-16">
        ...
        <div className="layout-three-col">
          ...
          <div className="relative">
            ...
            <p className="mt-2 ml-16 text-base text-iron-600">
              Share recipes with friends via private links or make them public.
              Control who sees your collection.
            </p>
          </div>
          ...
          <div className="relative">
            ...
            <p className="mt-2 ml-16 text-base text-iron-600">
              Keep recipes private, share with select friends, or publish to the
              community. You're in control.
            </p>
          </div>
