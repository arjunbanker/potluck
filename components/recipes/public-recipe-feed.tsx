    ...
    return (
      <div className="text-center py-12">
        ...
        <button
          ...
          className="px-4 py-2 bg-wood-500 text-white rounded-lg hover:bg-wood-600"
        >
          Try Again
        </button>
      </div>
  ...
  if (recipes.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <Link
          href="/recipes/import"
          className="mt-4 inline-flex items-center px-4 py-2 bg-wood-500 text-white rounded-lg hover:bg-wood-600"
        >
          Import & Share Recipe
        </Link>
      </div>
    ...
    <div>
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex gap-2">
          ...
          <Link
            href="/recipes/import"
            className="px-4 py-2 bg-wood-500 text-white rounded-lg hover:bg-wood-600 transition-colors flex items-center gap-2"
          >
            <svg
              className="w-4 h-4"
              fill="none"
