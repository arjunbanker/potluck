      ...
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center">
            <Link href="/" className="flex items-center text-wood-600 hover:text-wood-700">
                ...
                <div className="relative" ref={menuRef}>
                  ...
                  >
                    <div className="w-8 h-8 bg-linen-200 rounded-full flex items-center justify-center">
                      <svg className="w-5 h-5 text-iron-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="w-full px-4 sm:px-6 lg:px-8">
            <div className="py-2">
              <nav className="flex text-sm text-iron-500">
                <Link href="/" className="hover:text-iron-700">Home</Link>
                <span className="mx-2">/</span>
                <Link href="/dashboard" className="hover:text-iron-700">Recipes</Link>
                <span className="mx-2">/</span>
